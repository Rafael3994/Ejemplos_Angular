...
export class OnDemandPreloadingStrategy implements PreloadingStrategy {
    ...
    private decidirSiPrecargar(route: Route, preloadingOptions: PreloadingOptions): boolean {
        ...
        // * 3. Las opciones incluyen una rutaque está incluida en una lista de rutas que queremos precargar
        // * 4. Las opciones tienen en "preload" a true
    ...
    preload(route: Route, load: () => Observable<any>): Observable<any> {
        ...
        return this._preloadDemandOptions$.pipe(
            // Iteramos por cada valor recibido desde el sevicio con el next()
